...
var BulletUp = function(x, y) {
	Entity.call(this, x, y, 1, 1, "BulletUp");
	this.animation = [["∗"], ["※"]];
...
Entity.prototype.impart(BulletUp);	// Inherit from Entity

BulletUp.prototype.Draw = function(offsetX, offsetY) {
...
BulletUp.prototype.Update = function() {
